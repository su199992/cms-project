    ...
    <Modal
      ...
      <Box sx={modalStyle}>
        <Box sx={{ display: "flex", marginBottom: 3, justifyContent: "space-between" }}>
          <Box>
            <Button onClick={handleAddRow} variant="outlined" color="inherit" size="small">
              <AddIcon />
            </Button>
            <Button onClick={handleSaveData} variant="outlined" color="inherit" size="small">
              <DoneIcon />
            </Button>
          </Box>
          <Box>
                  ...
                  <TableCell component="th" scope="row">
                    {row.isNew ? (
                      <TextField
                        ...
                        onChange={(e) => handleChange(row.id, "administrator", e.target.value)}
                        fullWidth
                      />
                    ) : (
                      row.administrator
